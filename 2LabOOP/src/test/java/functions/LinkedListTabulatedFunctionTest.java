...
*/
    ...
    void testLinkedListWithArrayTrigonometricComposition() {
        ...
        assertEquals(java.lang.Math.sin(0.7071), composition.apply(java.lang.Math.PI/4), 0.1, "sin(cos(π/4))");
        assertEquals(java.lang.Math.sin(0.5), composition.apply(java.lang.Math.PI/3), 0.1, "sin(cos(π/3))");
        assertEquals(java.lang.Math.sin(0.0), composition.apply(java.lang.Math.PI/2), 0.1, "sin(cos(π/2)) = sin(0)");
    }
